...
function checkPasswordStrength($candidate) {
    $r1 = '/[A-Z]/';  //Uppercase
    $r2 = '/[a-z]/';  //lowercase
    $r3 = '/[!?@#$%^&*()\-_=+{};:,<.>]/';  // special char
    $r4 = '/[0-9]/';  //numbers
...
if (isset($_POST['submitReg'])) {
    ...
    if (checkPasswordStrength($password) == false)
        $errMsg .= 'Password must at least 8 characters long, with numbers, lowercase and uppercase letters and special chars';
...
if (isset($_POST['submitNewPass'])) {
    if (strcmp($_POST['password'], $_POST['passwordConfirm']) != 0) {
        ...
        && checkPasswordStrength($_POST['password']) == false) {
